...
from thermotar.thermo import async_parse_thermo,Thermo,async_create_thermos
import asyncio
...
async def test_async_create_thermos():
    async_result = await async_create_thermos('tests/test_files/log.lammps',last=True,join=True,get_properties=False)

    sync_result = Thermo.create_thermos('tests/test_files/log.lammps',last=True,join=True,get_properties=False)
